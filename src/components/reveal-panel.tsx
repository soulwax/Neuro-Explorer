...
export function RevealPanel({
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 rounded-[18px] border border-white/10 bg-slate-950/35 px-4 py-3">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {followUpLinks.map((moduleLink) => (
          <Link
            ...
            className="inline-flex min-h-10 items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200 transition hover:border-cyan-300/30 hover:bg-white/10 hover:text-white"
          >
