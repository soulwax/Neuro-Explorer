export function CaseQuestionPanel({
  ...
  return (
    <div className="rounded-[22px] border border-white/10 bg-slate-950/35 p-4 sm:p-5">
      ...
      <p className="mt-3 text-sm leading-6 text-slate-300">{oneLiner}</p>
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        ...
        <div className="rounded-[18px] border border-white/10 bg-slate-950/45 p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-300">{history}</p>
        </div>
      </div>

      <div className="mt-3 rounded-[18px] border border-white/10 bg-slate-950/45 p-4">
        <p className="text-xs uppercase tracking-[0.18em] text-slate-400">
          Syndrome frame
        </p>
        <p className="mt-2 text-sm leading-6 text-slate-300">
      ...
      <div className="mt-3 rounded-[18px] border border-cyan-300/20 bg-cyan-300/8 p-4">
